...
public class ObjectList implements ObjectListInterface{
     ...
     *
     * @param o Object to add to end of list
     */
     ...
     *
     * @param p ObjectListNode representing a node to be added to end of list
     */
     ...
     *
     * @return int count representing the size of the list
     */
    public int size() {
        int count = 0;
        ObjectListNode p = list;
     ...
     *
     * @return ObjectList copy of a list
     */
